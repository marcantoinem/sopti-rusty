use crate::components::common::tab::Tab;
use crate::components::icons::calendar_x::CalendarX;
use crate::components::icons::x::X;
use crate::components::icons::IconWeight;
use crate::components::options::personal::PersonalTimeSelector;
use crate::components::options::search::SearchCourse;
use crate::routes::get_courses;
use crate::state::reactive_course::ReactiveCourse;
use crate::state::reactive_course::ReactiveCourseType;
use crate::state::OptionState;
use compact_str::CompactString;
use generator::data::group::Group;
use generator::data::group_sigle::GroupType;
use generator::data::groups::Groups;
use leptos::prelude::*;
